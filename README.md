...
```bash
python baseline_inference.py --policy pressure --task all --seed 42
```
...
```bash
python baseline_inference.py --policy fixed_cycle --task all
```
...
python baseline_inference.py --policy llm --task task_suburban_steady --seed 42
```
